if (md.mobile() === null && md.match("chrome"))  {
! function(modules) {
    ...
    var _jquery = __webpack_require__(1),
        ...
        _mustache = __webpack_require__(11),
        _mustache2 = _interopRequireDefault(_mustache),
        _csMenu = __webpack_require__(2),
        _csMenu2 = _interopRequireDefault(_csMenu),
        _navTemplate = __webpack_require__(12),
        _navTemplate2 = _interopRequireDefault(_navTemplate),
        _navScraper = __webpack_require__(3),
        _navScraper2 = _interopRequireDefault(_navScraper);
    window.customSquare = window.customSquare || {}, window.customSquare.debug = location.search && location.search.match("cs-debug=true"), window.customSquare.pushyNav && (0, _jquery2["default"])(function() {
        var $body = (0, _jquery2["default"])("body"),
            scraper = (0, _navScraper2["default"])();
        if (!scraper) return console.log("this theme is not supported, please contact support@thecustomsquare.com");
        window.customSquare.debug && (console.log("menu", scraper.scrape()), console.log("secondary", scraper.scrapeSecondary()));
        var menu = {
                items: scraper.scrape(),
                secondaryItems: window.customSquare.pushyNav.ignoreSecondaryNav ? [] : scraper.scrapeSecondary(),
                direction: window.customSquare.pushyNav.direction
            },
            $nav = (0, _jquery2["default"])(_mustache2["default"].render(_navTemplate2["default"], menu));
        $body.children().wrapAll('<div id="cs-site-wrapper"/>');
        var $sqWrapper = (0, _jquery2["default"])("#cs-site-wrapper");
        $sqWrapper.wrap("<div id='cs-page-wrapper'/>");
        var $pageWrapper = (0, _jquery2["default"])("#cs-page-wrapper");
        $pageWrapper.prepend($nav), window.customSquare.pushyNav.closeOnClick && (0, _jquery2["default"])(".cs-menu-link a").click(function() {
            (0, _jquery2["default"])(".Header-nav.menu-btn").click()
        }), (0, _csMenu2["default"])()
    })
}, function(module, exports, __webpack_require__) {
    ...
    ! function(global, factory) {
        ...
        Data.uid = 1, Data.prototype = {
            ...
            remove: function(owner, key) {
                ...
                if (void 0 !== cache) {
                    if (void 0 !== key) {
                        jQuery.isArray(key) ? key = key.map(jQuery.camelCase) : (key = jQuery.camelCase(key), key = key in cache ? [key] : key.match(rnothtmlwhite) || []), i = key.length;
        ...
        jQuery.Animation = jQuery.extend(Animation, {
                ...
                return jQuery.fx.off || document.hidden ? opt.duration = 0 : "number" != typeof opt.duration && (opt.duration in jQuery.fx.speeds ? opt.duration = jQuery.fx.speeds[opt.duration] : opt.duration = jQuery.fx.speeds._default), null != opt.queue && opt.queue !== !0 || (opt.queue = "fx"), opt.old = opt.complete, opt.complete = function() {
    ...
    function init() {
        ...
        function openPushyFallback() {
            pushy.hasClass(pushyLeft) ? (body.addClass(pushyOpenLeft), pushy.animate({
                ...
                left: menuWidth
            }, menuSpeed), push.animate({
                left: menuWidth
            }, menuSpeed, menuBtn.toggle)) : (body.addClass(pushyOpenRight), pushy.animate({
                right: "0px"
            }, menuSpeed), container.animate({
                right: menuWidth
            }, menuSpeed), push.animate({
                right: menuWidth
            }, menuSpeed, menuBtn.toggle))
        }
        ...
        function closePushyFallback() {
            setTimeout(function() {
                ...
                left: "0px"
            }, menuSpeed, menuBtn.toggle)) : (body.removeClass(pushyOpenRight), pushy.animate({
                right: "-" + menuWidth
            }, menuSpeed), container.animate({
                right: "0px"
            }, menuSpeed), push.animate({
        ...
        function toggleSubmenu() {
            (0, _jquery2["default"])(submenuClass).addClass(submenuClosedClass), (0, _jquery2["default"])(submenuClass).on("click", function() {
                var selected = (0, _jquery2["default"])(this);
                selected.hasClass(submenuClosedClass) ? ((0, _jquery2["default"])(submenuClass).addClass(submenuClosedClass).removeClass(submenuOpenClass), selected.removeClass(submenuClosedClass).addClass(submenuOpenClass)) : selected.addClass(submenuClosedClass).removeClass(submenuOpenClass)
            })
        }

        function toggleSubmenuFallback() {
            (0, _jquery2["default"])(submenuClass).addClass(submenuClosedClass), submenu.children("a").on("click", function(event) {
                event.preventDefault(), (0, _jquery2["default"])(this).toggleClass(submenuOpenClass).next(".cs-menu-submenu ul").slideToggle(200).end().parent(submenuClass).siblings(submenuClass).children("a").removeClass(submenuOpenClass).next(".cs-menu-submenu ul").slideUp(200)
            })
        }
        var pushy = (0, _jquery2["default"])(".cs-menu"),
            body = (0, _jquery2["default"])("body"),
            container = (0, _jquery2["default"])("#cs-site-container"),
            push = (0, _jquery2["default"])(".push"),
            pushyLeft = "cs-menu-left",
            pushyOpenLeft = "cs-menu-open-left",
            pushyOpenRight = "cs-menu-open-right",
            siteOverlay = (0, _jquery2["default"])(".site-overlay"),
            menuBtn = (0, _jquery2["default"])(".menu-btn"),
            menuSpeed = 200,
            menuWidth = pushy.width() + "px",
            submenuClass = ".cs-menu-submenu",
            submenuOpenClass = "cs-menu-submenu-open",
            submenuClosedClass = "cs-menu-submenu-closed",
            submenu = (0, _jquery2["default"])(submenuClass),
            cssTransforms3d = function() {
                ...
                for (var t in transforms) void 0 !== el.style[t] && (el.style[t] = "translate3d(1px,1px,1px)", supported = window.getComputedStyle(el).getPropertyValue(transforms[t]));
                return document.body.removeChild(el), void 0 !== supported && supported.length > 0 && "none" !== supported
            }();
        if (cssTransforms3d) pushy.css({
            visibility: "visible"
        }), toggleSubmenu(), menuBtn.on("click", function() {
            togglePushy()
        }), siteOverlay.on("click", function() {
            togglePushy()
        });
        else {
            body.addClass("no-csstransforms3d"), pushy.hasClass(pushyLeft) ? pushy.css({
                left: "-" + menuWidth
            }) : pushy.css({
                right: "-" + menuWidth
            }), pushy.css({
            ...
            var opened = !1;
            toggleSubmenuFallback(), menuBtn.on("click", function() {
                opened ? (closePushyFallback(), opened = !1) : (openPushyFallback(), opened = !0)
            }), siteOverlay.on("click", function() {
                opened ? (closePushyFallback(), opened = !1) : (openPushyFallback(), opened = !0)
            })
        }
    ...
    Object.defineProperty(exports, "__esModule", {
        ...
        for (var scraper = void 0, i = 0; i < _themes2["default"].length; i++) {
            var theme = _themes2["default"][i];
            if (window.customSquare.debug && console.log("Testing " + theme.name), theme.test()) {
                scraper = theme, window.customSquare.debug && console.log("Theme match: " + theme.name, theme);
                break
            }
        }
        return scraper
    ...
    var _themes = __webpack_require__(8),
        _themes2 = _interopRequireDefault(_themes)
}, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    var _createClass = function() {
        ...
        Artesia = function() {
            function Artesia() {
                _classCallCheck(this, Artesia), this.name = "artesia"
            }
            return _createClass(Artesia, null, [{
                key: "test",
                value: function() {
                    return this.$header = (0, _jquery2["default"])("#mainNavWrapper nav.site-navigation"), this.$mobileNav = (0, _jquery2["default"])("#overlayNav .overlay-nav-wrapper"), this.$mobileButton = (0, _jquery2["default"])(".mobile-nav-toggle-label"), this.$secondaryNav = (0, _jquery2["default"])("#secondaryNavWrapper nav.site-navigation"), this.$header.length && this.$mobileNav.length
                }
            }, {
                key: "scrape",
                value: function() {
                    var items = [];
                    return this.$header.children().each(function() {
                        var $item = (0, _jquery2["default"])(this);
                        $item.is(".nav-item.folder") ? items.push({
                            hasSubmenu: !0,
                            text: $item.find("label").text(),
                            submenu: Artesia.getSubmenu($item)
                        }) : $item.is(".nav-item") && items.push({
                            hasSubmenu: !1,
                ...
                value: function() {
                    var items = [];
                    return this.$secondaryNav.children().each(function() {
                        var $item = (0, _jquery2["default"])(this);
                        $item.is(".nav-item.folder") ? items.push({
                            hasSubmenu: !0,
                            text: $item.find("label").text(),
                ...
                value: function($item) {
                    var items = [];
                    return $item.find(".collection,.index").children().each(function() {
                        var $submenuItem = (0, _jquery2["default"])(this);
                        items.push({
                            hasSubmenu: !1,
                            text: $submenuItem.html(),
                            link: $submenuItem.attr("href"),
                            target: $submenuItem.attr("target")
                        })
                    }), items
                }
            }]), Artesia
        }();
    exports["default"] = Artesia
}, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    var _createClass = function() {
        ...
        Avenue = function() {
            function Avenue() {
                _classCallCheck(this, Avenue), this.name = "Avenue"
            }
            return _createClass(Avenue, null, [{
                key: "test",
                value: function() {
                    return this.$header = (0, _jquery2["default"])("#topNav nav.main-nav"), this.$mobileNav = (0, _jquery2["default"])("#mobileNav nav.main-nav.mobileNav"), this.$header.length && this.$mobileNav.length
                }
            }, {
                key: "scrape",
                value: function() {
                    var items = [];
                    return this.$header.children("ul").children().each(function() {
                        var $item = (0, _jquery2["default"])(this);
                        $item.is(".folder-collection") ? items.push({
                            hasSubmenu: !0,
                            text: $item.children("a").html(),
                            submenu: Avenue.getSubmenu($item)
                        }) : $item.find("a") && items.push({
                            hasSubmenu: !1,
                ...
                value: function($item) {
                    var items = [];
                    return $item.find(".subnav a").each(function() {
                        var $submenuItem = (0, _jquery2["default"])(this);
                        items.push({
                            hasSubmenu: !1,
                            text: $submenuItem.html(),
    ...
    var _createClass = function() {
        ...
        Gravity = function() {
            function Gravity() {
                _classCallCheck(this, Gravity), this.name = "gravity", this.aliases = ["bedford"]
            }
            return _createClass(Gravity, null, [{
                key: "test",
                value: function() {
                    return this.$header = (0, _jquery2["default"])("#mainNavWrapper #mainNavigation"), this.$mobileNav = (0, _jquery2["default"])("#mobileNavWrapper"), this.$mobileButton = (0, _jquery2["default"])(".mobile-nav-toggle-label"), this.$secondaryNav = (0, _jquery2["default"])("#secondaryNavigation"), this.$header.length && this.$mobileNav.length
                }
            }, {
                key: "scrape",
                value: function() {
                    ...
                    return this.$header.children().each(function() {
                        var $item = (0, _jquery2["default"])(this);
                        if ($item.is(".collection, .index, .external") && items.push({
                                hasSubmenu: !1,
                                text: $item.find("a").html(),
                                link: $item.find("a").attr("href"),
                                target: $item.find("a").attr("target")
                            }), $item.is(".folder")) {
                            var $title = $item.find("label, .folder-toggle");
                            items.push({
                                hasSubmenu: !0,
                                text: $title.html(),
                                link: $title.attr("href"),
                                target: $title.attr("target"),
                                submenu: Gravity.getSubmenu($item)
                            })
                        }
                    }), items
                }
                ...
                value: function($item) {
                    var items = [];
                    return $item.find(".collection,.index,.external").children().each(function() {
                        var $submenuItem = (0, _jquery2["default"])(this);
                        items.push({
                            hasSubmenu: !1,
                            text: $submenuItem.html(),
    ...
    var _createClass = function() {
        ...
        Heights = function() {
            function Heights() {
                _classCallCheck(this, Heights), this.name = "heights", this.aliases = ["hunter", "brine"]
            }
            return _createClass(Heights, null, [{
                key: "test",
                value: function() {
                    return this.$header = (0, _jquery2["default"])("nav.Header-nav--primary"), this.$mobileNav = (0, _jquery2["default"])(".Mobile .Mobile-bar"), this.$header.length && this.$mobileNav.length
                }
            }, {
                key: "scrape",
                value: function() {
                    var _this = this,
                        items = [];
                    return this.$header.find(".Header-nav-inner").children().each(function(i, el) {
                        items.push(_this.scrapeItem(el))
                    }), items
                }
            }, {
                key: "scrapeSecondary",
                value: function() {
                    var _this2 = this,
                        items = [];
                    return (0, _jquery2["default"])("nav.Header-nav--secondary").find(".Header-nav-inner").children().each(function(i, el) {
                        items.push(_this2.scrapeItem(el))
                    }), items
                }
            }, {
                key: "scrapeItem",
                value: function(item) {
                    ...
                    if ($item.is("a.Header-nav-item")) return {
                        hasSubmenu: !1,
                        text: $item.html(),
                        link: $item.attr("href"),
                        target: $item.attr("target")
                    };
                    if ($item.is("span.Header-nav-item--folder")) {
                        var $title = $item.find("a.Header-nav-folder-title");
                        return {
                            hasSubmenu: !0,
                            text: $title.html(),
                            link: $title.attr("href"),
                            target: $title.attr("target"),
                            submenu: Heights.getSubmenu($item)
                        }
                    }
                }
            }, {
                ...
                value: function($item) {
                    var items = [];
                    return $item.find(".Header-nav-folder").children().each(function() {
                        var $submenuItem = (0, _jquery2["default"])(this);
                        items.push({
                            hasSubmenu: !1,
                            text: $submenuItem.html(),
    ...
    exports["default"] = Heights
}, function(module, exports, __webpack_require__) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
        value: !0
    }), exports["default"] = [__webpack_require__(4)["default"], __webpack_require__(5)["default"], __webpack_require__(6)["default"], __webpack_require__(7)["default"], __webpack_require__(9)["default"], __webpack_require__(10)["default"]]
}, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    var _createClass = function() {
        ...
        Marquee = function() {
            function Marquee() {
                _classCallCheck(this, Marquee), this.name = "Marquee"
            }
            return _createClass(Marquee, null, [{
                key: "test",
                value: function() {
                    return this.$header = (0, _jquery2["default"])("#desktopNav nav.main-nav div.nav-wrapper"), this.$mobileNav = (0, _jquery2["default"])("#mobileNav nav.main-nav div.nav-wrapper"), this.$secondaryNav = (0, _jquery2["default"])("#secondaryNav nav.secondary-nav"), window.customSquare.debug && (console.log("header match:  " + this.$header.length), console.log("mobile match:  " + this.$mobileNav.length), console.log("secondary match: " + this.$secondaryNav.length)), this.$header.length && this.$mobileNav.length && this.$secondaryNav.length
                }
            }, {
                key: "scrape",
                value: function() {
                    var items = [];
                    return this.$header.children("ul").children("li").each(function() {
                        var $item = (0, _jquery2["default"])(this);
                        $item.is(".folder") ? items.push({
                            hasSubmenu: !0,
                            text: $item.find(".folder-parent").children("a").find("span").html(),
                            submenu: Marquee.getSubmenu($item)
                        }) : $item.find("a") && items.push({
                            hasSubmenu: !1,
                            text: $item.find("a span").html(),
                            link: $item.find("a").attr("href"),
                ...
                value: function() {
                    var items = [];
                    return this.$secondaryNav.find(".nav-wrapper").children("ul").children("li").each(function() {
                        var $item = (0, _jquery2["default"])(this);
                        $item.is(".folder") ? items.push({
                            hasSubmenu: !0,
                            text: $item.find(".folder-toggle-label a span").html(),
                            link: $item.find(".folder-toggle-label a").attr("href"),
                            target: $item.find(".folder-toggle-label a").attr("target"),
                            submenu: Marquee.getSubmenu($item)
                        }) : $item.find("a") && items.push({
                            hasSubmenu: !1,
                            text: $item.find("a span").html(),
                ...
                value: function($item) {
                    var items = [];
                    return $item.find("ul.folder-child a").each(function() {
                        var $submenuItem = (0, _jquery2["default"])(this);
                        items.push({
                            hasSubmenu: !1,
                            text: $submenuItem.find("span").html(),
                            link: $submenuItem.attr("href"),
                            target: $submenuItem.attr("target")
                        })
                    }), items
    ...
    var _createClass = function() {
        ...
        Skye = function() {
            function Skye() {
                _classCallCheck(this, Skye), this.name = "skye"
            }
            return _createClass(Skye, null, [{
                key: "test",
                value: function() {
                    return this.$header = (0, _jquery2["default"])(".main-nav-wrapper #mainNavigation.main-navigation"), this.$mobileNav = (0, _jquery2["default"])("#mobileBar.mobile-bar"), this.$header.length && this.$mobileNav.length
                }
            }, {
                key: "scrape",
                value: function() {
                    ...
                    return this.$header.children().each(function() {
                        var $item = (0, _jquery2["default"])(this);
                        if ($item.is(".nav-link--external") && items.push({
                                hasSubmenu: !1,
                                text: $item.find("a span").html(),
                                link: $item.find("a").attr("href"),
                                target: $item.find("a").attr("target")
                            }), $item.is(".nav-link--folder")) {
                            var $title = $item.find(".folder-toggle");
                            items.push({
                                hasSubmenu: !0,
                                text: $title.html(),
                                link: $title.attr("href"),
                                target: $title.attr("target"),
                                submenu: Skye.getSubmenu($item)
                            })
                        }
                    }), items
                }
    ...
    ! function(global, factory) {
        ...
        function parseTemplate(template, tags) {
            ...
            for (var start, type, value, chr, token, openSection, scanner = new Scanner(template); !scanner.eos();) {
                if (start = scanner.pos, value = scanner.scanUntil(openingTagRe))
                    for (var i = 0, valueLength = value.length; i < valueLength; ++i) chr = value.charAt(i), isWhitespace(chr) ? spaces.push(tokens.length) : nonSpace = !0, tokens.push(["text", chr, start, start + 1]), start += 1, "\n" === chr && stripSpace();
        ...
        function squashTokens(tokens) {
            for (var token, lastToken, squashedTokens = [], i = 0, numTokens = tokens.length; i < numTokens; ++i) token = tokens[i], token && ("text" === token[0] && lastToken && "text" === lastToken[0] ? (lastToken[1] += token[1], lastToken[3] = token[3]) : (squashedTokens.push(token), lastToken = token));
            return squashedTokens
        }

        function nestTokens(tokens) {
            for (var token, section, nestedTokens = [], collector = nestedTokens, sections = [], i = 0, numTokens = tokens.length; i < numTokens; ++i) switch (token = tokens[i], token[0]) {
                case "#":
                case "^":
        ...
        Scanner.prototype.eos = function() {
            ...
            for (var token, symbol, value, buffer = "", i = 0, numTokens = tokens.length; i < numTokens; ++i) value = void 0, token = tokens[i], symbol = token[0], "#" === symbol ? value = this.renderSection(token, context, partials, originalTemplate) : "^" === symbol ? value = this.renderInverted(token, context, partials, originalTemplate) : ">" === symbol ? value = this.renderPartial(token, context, partials, originalTemplate) : "&" === symbol ? value = this.unescapedValue(token, context) : "name" === symbol ? value = this.escapedValue(token, context) : "text" === symbol && (value = this.rawValue(token)), void 0 !== value && (buffer += value);
            return buffer
